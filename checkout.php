                ...
                <section
                    ...
                    <div
                        ...
                        <div style="flex: 1; margin-left: 1.5rem;">
                            <h4 style="margin: 0; font-size: 1.2rem; font-weight: bold; color: #333;">Dell Astro 93G PC</h4>
                            <p style="margin: 0.5rem 0; font-size: 1rem; color: #777;">Dell Astro 93G: Power-packed</p>
                            <p style="margin: 0; font-size: 1.2rem; font-weight: bold; color: #333;">Rs. 300,000/-</p>
                        </div>
                    ...
                    <div
                        style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem; border-bottom: 1px solid #ddd; padding-bottom: 1.5rem;">
                        <img src="./images/im3.png" alt="Product Image"
                            style="width: 100px; height: auto; border-radius: 10px;">
                        <div style="flex: 1; margin-left: 1.5rem;">
                            <h4 style="margin: 0; font-size: 1.2rem; font-weight: bold; color: #333;">MI Pods G3</h4>
                            <p style="margin: 0.5rem 0; font-size: 1rem; color: #777;">MI Pods G3: Wireless, sleek design, immersive sound, long-lasting battery.</p>
                            <p style="margin: 0; font-size: 1.2rem; font-weight: bold; color: #333;">Rs.25,000/-</p>
                        </div>
                        <div style="display: flex; align-items: center; gap: 0.5rem;">
                            <button onclick="decrementQuantity(this)"
                                style="padding: 0.5rem 1rem; border: 1px solid #ddd; background-color: #fff; border-radius: 5px; cursor: pointer;color: #333">-</button>
                ...
                <section class="summary-section">
                    ...
                    <div class="summary">
                        <div
                            ...
                            <img src="./images/im2.png" alt="Product Name"
                                style="width: 50px; height: auto; border-radius: 5px;">
                            <p>Dell Astro 93G PC</p>
                            <p>Rs. 300,000/-</p>
                        </div>
                        <div
                            style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
                            <img src="./images/im3.png" alt="Product Name"
                                style="width: 50px; height: auto; border-radius: 5px;">
                            <p>MI Pods G3</p>
                            <p>Rs. 25,000/-</p>
                        </div>
                ...
                <section
                    ...
                    <div>
                        <div
                            ...
                            <img src="./images/im2.png" alt="Product Name"
                                style="width: 50px; height: auto; border-radius: 5px;">
                            <p style="margin: 0; font-size: 1rem; color: #333;">Dell Astro 93G PC</p>
                            <p style="margin: 0; font-size: 1rem; color: #333;">Rs. 300,000/-</p>
                        </div>
                        <div
                            style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
                            <img src="./images/im3.png" alt="Product Name"
                                style="width: 50px; height: auto; border-radius: 5px;">
                            <p style="margin: 0; font-size: 1rem; color: #333;">MI Pods G3</p>
                            <p style="margin: 0; font-size: 1rem; color: #333;">Rs. 25,000/-</p>
                        </div>
                        <div style="margin-bottom: 1rem; border-top: 1px solid #ddd; padding-top: 1rem;">
