...
<body>
    ...
    <main>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem;">
            <form class="contact-form" id="contactPageForm" action="submit.php" method="POST">
            ...
            <div class="contact-info">
                ...
                <p><strong>Address:</strong>Poson mawatha,21000</p>
                <p><strong>Email:</strong> support@zapgear.com</p>
